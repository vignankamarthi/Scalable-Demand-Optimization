...
The data was recorded on two trolley buses during regular operation by Verkehrsbetriebe Zurich (VBZ).
...
> F. Widmer, A. Ritter, M. Achermann, F. Bueler, J. Bagajo, and C. H. Onder, "Highly Efficient Year-Round
...
This sample Matlab code is added to the code repository for convenience. It is subject to the GNU
